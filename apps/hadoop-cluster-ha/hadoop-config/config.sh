...
RESOURCE_MANAGER_HOSTNAME_0=hadoop-hdfs-resourcemanager-0
RESOURCE_MANAGER_HOST_0=$RESOURCE_MANAGER_HOSTNAME_0.hadoop-resourcemanager-headless.$MY_NAMESPACE.svc.cluster.local
