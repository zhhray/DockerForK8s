...
NODE_TYPE=${2:-"master"}
KUBE_TOKEN=${3:-"91a0f6.03d145d4ef604315"}
...
echo "config --pod-infra-container-image=zhhray/pause-amd64:${KUBE_PAUSE_VERSION}"

if [ ! -f "/etc/systemd/system/kubelet.service.d/20-pod-infra-image.conf" ]; then
cat > /etc/systemd/system/kubelet.service.d/20-pod-infra-image.conf <<EOF
[Service]
Environment="KUBELET_EXTRA_ARGS=--pod-infra-container-image=zhhray/pause-amd64:${KUBE_PAUSE_VERSION}"
EOF
fi
...
#echo '============================================================'
#CR_URL=gcr.io/google_containers
#MY_URL=registry.cn-hangzhou.aliyuncs.com/szss_k8s
#
#images=(
